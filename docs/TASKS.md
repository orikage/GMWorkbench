...
| T-120 | 未着手 | 初回オンボーディングの導線整備 | 空の状態でも操作手順とサンプルを提示 | 2025-10-12 |
| T-121 | 未着手 | PDF内検索とアウトラインナビの追加 | 文字検索と目次ジャンプで参照速度を向上 | 2025-10-12 |
| T-122 | 未着手 | セッションのエクスポート/インポート | IndexedDB 状態をファイルとして保存・復元 | 2025-10-12 |
| T-123 | 未着手 | E2Eテスト基盤の整備 | Playwright で主要操作を自動検証 | 2025-10-12 |
